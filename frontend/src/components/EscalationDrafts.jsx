      ...
      <div className="escalation-grid">
        <EscalationDoc
          ...
          body={[
            ...
            `This report documents a temperature excursion and suspected seal compromise during transport. Sensor data indicates the product was exposed to conditions outside the approved range (${shipment.tempRange}) for an estimated duration of 3m 42s. A 3.8g shock event was recorded immediately prior to the thermal excursion, suggesting physical mishandling.`,
            ``,
            `ESTIMATED IMPACT:`,
        ...
        {isCompromised && (
          <EscalationDoc
            ...
            body={[
              ...
              ``,
              `SUMMARY OF LOSS:`,
              `The referenced shipment sustained condition-compromising events during transit, including a physical shock event (3.8g), suspected seal breach, and temperature excursion above the approved range. The resulting Product Viability Score of ${analysis.viabilityScore.toFixed(1)}% indicates material degradation inconsistent with the original shipment specification.`,
              ``,
              `SUPPORTING EVIDENCE:`,
